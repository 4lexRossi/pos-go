...
import (
	...
	"github.com/4lexRossi/pos-go/18-UOW/internal/db"
	"github.com/4lexRossi/pos-go/18-UOW/internal/repository"
	"github.com/4lexRossi/pos-go/18-UOW/pkg/uow"
...
func TestFailAddCourseUow(t *testing.T) {
	dbt, err := sql.Open("mysql", "root:root@tcp(localhost:3306)/courses")
	assert.NoError(t, err)
